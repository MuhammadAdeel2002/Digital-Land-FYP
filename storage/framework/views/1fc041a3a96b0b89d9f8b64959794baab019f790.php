                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="media align-items-center justify-content-between mb-3">
                            ...
                            <a href="<?php echo e(url()->previous()); ?>" class="btn btn-sm btn-primary btn-rounded"><?php echo app('translator')->get('Back'); ?></a>
                        </div>
                                                    ...
                                                    <div class="col-md-4 source-parent">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="image-input ">
                                                                ...
                                                                <img id="image_preview_container" class="preview-image" src="<?php echo e(getFile(config('location.template.path').(isset($templateMedia->description->{$name}) ? $templateMedia->description->{$name} : ''))); ?>"
                                                                     alt="preview image">
                                                            </div>
                                                            <?php $__errorArgs = [$name.'.'.$language->id];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Naveed\Desktop\digitalland\resources\views/admin/template/show.blade.php ENDPATH**/ ?>